...
var commentHistoryTemplateStr = ["        <div class=\"comment-history clearfix\">",
...
var commentHistoryTemplateEl = new EJS({text:commentHistoryTemplateStr}).render(commentHistoryTemplateData,undefined);
commentsHistory.innerHTML +=commentHistoryTemplateEl;*/
