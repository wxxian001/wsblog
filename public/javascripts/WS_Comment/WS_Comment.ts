...
class WS_Comment {
    ...
    private commentRelyInputText:HTMLElement;
    private commentRelyInputUserName:HTMLElement;
    private commentRelyInputMail:HTMLElement;
    private commentRelyError:HTMLElement;

    private commentRelyErrorMsg:Array;

    private path:string;
    private parentElId:string;

    private commentHistoryTemplateStr = [
    ...
    constructor(articleId:string,parentElId:string) {
   ...
   initData(){
    ...
    private isEmptyOfRely(el:HTMLElement,placeholder:string):boolean{
     ...
     *  }]
     */
    private setPlaceholder(array : Array){
        var me = this;
